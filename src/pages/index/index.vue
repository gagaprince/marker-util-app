<template>
	<view class="content">
		<view class="control">
			<!-- <button @click="getTTwid">获取ttwid</button>
			<view class="lb word-wrap">ttwid: {{ttwid}}</view>
			<button @click="getRealLinkByOriginLink">获取真实链接</button>
			<view class="lb word-wrap">
				link: {{realLink}}
			</view>
			<button @click="getAwemeIdByOriginLink">获取媒体id</button>
			<view class="lb word-wrap">
				awemeId: {{awemeId}}
			</view> -->
